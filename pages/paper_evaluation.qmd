...
```{python}
plot_scatter('STRESS-DES criteria met',
             sho = (17/24)*100,
             hua = (14/23)*100,
             lim = (16/21)*100,
             kim = (15/22)*100,
...
<!-- TODO: update after discussion of Kim et al. 2021 -->
...
Below, I've reflected on the impact of each criteria being fulfilled, on the reproduction. I've also identified where I feel I've been a bit more lax in my evaluation. <!-- TODO: Consider - is this an issue? Should I revisit those and be more strict? -->
...
<!--TODO: Check Lim 2020 - think it should be changed to partially met, as no justification mentioned -->
...
<!--TODO: Check Huang 2019, looks like I've answered with arrival sampling, but that is not relevant here - but does indicate that the wording here is a little confusing perhaps -->
...
These guidelines have quite a different focus from STRESS-DES. STRESS-DES is very focused on what and how modelling work is performed. These guidelines do cover that, but have quite alot of focus on validity of the work, and good practice (e.g. stating funding, involving stakeholders).

<!--TODO: Add reflections on each of the elements -->
...
* Good practice, usually a journal requirement, although some did not have.
...
<!--TODO: Add reflections on this, and relationship between these and then e.g. how many of the reporting guidelines were met -->

```{python}
import plotly.express as px

# For each study, define (a) whether use a previously reported model, and (b) proportion of applicable STRESS-DES fully met
previous_stress =  [
  (0, (17/24)*100),
  (0, (14/23)*100),
  (0, (16/21)*100),
...
<!--TODO: Improve this plot so (a) it's not a massive gap between the bars, (b) it's a function used for this and above rather than duplicate code, (c) so we have ones for STRESS and ISPOR -->

<!-- TODO: consider, did the previously reported model also use reporting guidelines? -->
