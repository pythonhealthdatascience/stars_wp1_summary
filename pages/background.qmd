...
<!--TODO: Write this up, currently just some notes and ideas - or, could leave as notes.-->

@baker_1500_2016 - survey of 1576 researchers across disciplines, finding:
...
(I.e. terminology I researched previously, **computational reproducibiltiy** etc, similar to how lots of articles define it, e.g. @samuel_computational_2024).

@korbmacher_replication_2023 - great discussion of the **replication** crisis

On the [protocol page](protocol.qmd), several reproducibility studies are mentioned, which were used to help inform the methods in our reproducibility assessments.
