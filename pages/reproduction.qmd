...
**@hernandez_optimal_2015:** TBC <!-- TODO -->

**@wood_value_2021:** TBC <!-- TODO -->
...
| Hernandez et al. 2015 | 8 items:<br>• 6 figures<br>• 2 tables | TBC | TBC |
| Wood et al. 2021 | 5 items:<br>• 4 figures<br>• 1 table | TBC | TBC |

## Time to completion

<!-- TODO: Add Johnson et al. 2021, Hernandez et al. 2015 and Wood et al. 2021 once conducted reproduction -->
...
to_plot = [
    ...
    # (df_her, 'Hernandez<br>et al. 2015', '#117733'),
    # (df_woo, 'Woord et al.<br>2021', '#882255')
]
```
