...
| Open licence | ❌ | ✅ | ✅ | ✅ | ❌ |
| Complete (all relevant artefacts are available) | ❌ | ❌ | ✅ | ❌ | ✅ |
| Sufficient explanation to "understand how the code is used and relates to the reported methodology, including information about versions of software, systems, and packages." | ❌ | ❌ | ❌ | ✅ | ❌ |
...
| - | - | - | - |
| Documentation with: (a) inventory of artefacts (b) sufficient description for artefacts to be exercised | ✅ | ✅ | ❌ |
