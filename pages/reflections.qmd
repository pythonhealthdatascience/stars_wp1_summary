...
## Run time, memory usage and file size
...
* @johnson_cost_2021: <!--TODO-->
* @hernandez_optimal_2015: <!--TODO-->
* @wood_value_2021: Aggregate results files are small (327 kB), but raw results files are very large (2.38 GiB), and even when compressed to `.csv.gz` (128 MiB) require using of GitHub LFS
...
@wood_value_2021: Outputs to `.csv` files.
...
@lim_staff_2020, @anagnostou_facs-charm_2022, @wood_value_2021: Not applicable (no in-text results).
